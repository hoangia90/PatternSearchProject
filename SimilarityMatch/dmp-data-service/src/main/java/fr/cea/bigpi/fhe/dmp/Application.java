...
public class Application {
	...
	private final String basePackage = "fr.cea.bigpi.fhe.dmp.controller";
	...
	private ApiInfo metadata() {
		return new ApiInfoBuilder().title("DMP - DATA Service API documentation")
				.description("This is API documentation for working with DMP - DATA Function Engine")
