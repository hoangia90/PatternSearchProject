...
@Service
public class FHEGenericService {

	protected Logger logger = LoggerFactory.getLogger(FHEGenericService.class.getName());
	...
	@Autowired private FHESimilarityMatchingService seal; 
	
	
	@Autowired
	public FHEGenericService(@Value("${spring.application.name}") String appName)
	{
