...
public class Application {
	...
	private final String basePackage = "fr.cea.bigpi.fhe.dap.controller"; 
    /**
	...
	private ApiInfo metadata() {
        return new ApiInfoBuilder()
    		  .title("DAP - Analysis Service API documentation")
              .description("This is API documentation for working with DAP - Function Engine")
              .license("CEA 2.0")
